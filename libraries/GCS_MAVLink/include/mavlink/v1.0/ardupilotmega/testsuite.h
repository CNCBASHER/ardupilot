...
static void mavlink_test_camera_feedback(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_camera_feedback_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_camera_feedback_pack(system_id, component_id, &msg , packet1.cam_idx , packet1.img_idx , packet1.time_usec , packet1.lat , packet1.lng , packet1.alt , packet1.roll , packet1.pitch , packet1.heading , packet1.fov );
	mavlink_msg_camera_feedback_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_camera_feedback_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.cam_idx , packet1.img_idx , packet1.time_usec , packet1.lat , packet1.lng , packet1.alt , packet1.roll , packet1.pitch , packet1.heading , packet1.fov );
	mavlink_msg_camera_feedback_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_camera_feedback_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_camera_feedback_send(MAVLINK_COMM_1 , packet1.cam_idx , packet1.img_idx , packet1.time_usec , packet1.lat , packet1.lng , packet1.alt , packet1.roll , packet1.pitch , packet1.heading , packet1.fov );
	mavlink_msg_camera_feedback_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
